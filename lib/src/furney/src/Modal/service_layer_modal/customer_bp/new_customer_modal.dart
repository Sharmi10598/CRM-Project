...
CustomerDetailsValue({
 // this.cardName,
  required this.phone1, required this.phone2, required this.currentAccountBalance, required this.bpaddress, // required this.openDeliveryNotesBalance,
  // this.bpFiscalTaxIDCollection,
  required this.creditLimit, required this.priceListNum, required this.emailAddress, required this.website, required this.contactPerson, required this.billTodefault, required this.shipTodefault, // required this.groupCode,
  // this.cardCode,
   this.cardType,
  this.notes,
 ...
 //     cardName: jsons['CardName'].toString(),
    ...
    contactEmployees :dataList2,
       ...
       emailAddress:jsons['EmailAddress']==null?'':jsons['EmailAddress'].toString(),
       website: jsons["Website"]==null?'':jsons['Website'].toString(),
       contactPerson: jsons["ContactPerson"]==null?'':jsons['ContactPerson'].toString(),
...
BpAddress({
  required this.addressName,
   required this.zipCode, required this.city, required this.country2, //required this.bpaddress,
  required this.state, this.street,
   this.county,
   this.block,
 ...
 factory BpAddress.fromJson(dynamic jsons) {
    ...
    //       .toList();
    return BpAddress(
      addressName: jsons['AddressName'] == null?'' :jsons['AddressName'].toString(), 
