  ...
  static Future<NotificationModel> getGlobalData(PushNotify pshNotify) async {
    ...
    final response = await http.post(
      ...
      'https://fcm.googleapis.com/fcm/send',
        ...
        'Authorization': 'key=AAAAeAM_7bw:APA91bHwQqF9k3-JMdcnbMvK3VzL31Xokv7hWBBIsNQmUJ6nFc3gSOQ-U6vLeZSqoZSWOEtB-f1p9GDiUmiFq_vOIRd_7d3cvOg-FTglywTGmpDZq58CA1lzeBb_FlAvyo6RdgZwPac2'
        },
