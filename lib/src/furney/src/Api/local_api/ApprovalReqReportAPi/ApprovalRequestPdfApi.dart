...
class ApprovalReqApi {
  static Future<int> getGlobalData(
    ...
    try {
      log(URL.reportUrl + 'ApprovalRequest/$custCode');
      final response = await http.get(
        Uri.parse(
          URL.reportUrl + 'ApprovalRequest/$custCode',
        ),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        final file = await File('${tempDir.path}/ApprovalRequest-$custCode.pdf')
            .create();
        print('${tempDir.path}/ApprovalRequest-$custCode.pdf');
