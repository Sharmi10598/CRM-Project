...
class LogoutUserAPi{  
  ...
  static Future<LogOutApiModel> getGlobalData(LogOutDataModel logout) async {
    try {
      print('${URL.urlLocal}ResetDevicecode');
    ...
    "UserCode":"${logout.userCode}"
      ...
      if (response.statusCode == 200) {
       // print(json.decode(response.body));
        return LogOutApiModel.fromJson(json.decode(response.body)as Map<String,dynamic>,response.statusCode);
      }
       else {
      //    print(json.decode(response.body));
      return LogOutApiModel.fromJson(json.decode(response.body)as Map<String,dynamic>,response.statusCode);
      ...
      // print(e);
      return LogOutApiModel.issue('Restart the app or contact the admin!!..',500);
    }
  }
