...
class SalesRepState extends State<SalesRep> {
  ...
  SalesRepAPi.getGlobalData().then((val) {
    if(val.salesrepData !=null){
      print(val.salesrepData![0].employeName);
                ...
                return Card(
                  child: Container(
                   // color: Colors.grey[200],
                    padding: EdgeInsets.symmetric(vertical: Screens.heigth(context)*0.01,horizontal: Screens.width(context)*0.02),
                    child: Row(
                        ...
                        Column(
                          ...
                          children: [
                            SizedBox(
                             ...
                             // color: Colors.amber,
                              child: Text('${salesRepDataFilter[i].employeName}',
                              style: TextStyles.boldPC1(context),),),
                           SizedBox(
                              width: Screens.width(context)*0.7,
                             // color: Colors.amber,
                              child: Text('${salesRepDataFilter[i].roll}',
                          ...
                          SizedBox(
                             width: Screens.width(context)*0.7,
                            //  color: Colors.amber,
                              child: Text('${salesRepDataFilter[i].email}',
                              style: TextStyles.bodytextBlack1(context),),),
                            
                          SizedBox(
                             width: Screens.width(context)*0.7,
                            //  color: Colors.amber,
                              child: Text('${salesRepDataFilter[i].phone}',
                              style:TextStyles.bodytextBlack1(context),),),
                          ],
                        ),
                       Column(
                            children: [
                             ...
                             // color: Colors.amber,
                              child: Text('${salesRepDataFilter[i].branch}',
