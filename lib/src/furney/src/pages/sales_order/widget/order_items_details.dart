...
class SalesOrderItems extends StatefulWidget {
  const SalesOrderItems({required this.title, Key? key}) : super(key: key);
  final String title;
  @override
  SalesOrderItemsState createState() => SalesOrderItemsState();
}

class SalesOrderItemsState extends State<SalesOrderItems> {
  static int index = 0;
