   ...
   void getmoredata(){
      DeliveryAPi.callNextLink().then((val) {
        setState(() {
          swipeLoad=true;
          if(val.deliveryModaleValue != null){
              print('deliveryValueFilter3:'+deliveryValueFilter.length.toString());
        for (int i =0; i<lenthofList; i++ ){
            deliveryValueFilter.add(DeliveryModaleValue(DocDate: 
            val.deliveryModaleValue![i].DocDate,
             cardCode: 
             val.deliveryModaleValue![i].cardCode,
         cardName:
         val.deliveryModaleValue![i].cardName,
          docEntry:
          val.deliveryModaleValue![i].docEntry,
          DocNum: 
          val.deliveryModaleValue![i].DocNum,
        ),);
        }  
         swipeLoad=false;
                ...
                controller: mycontroller[0],
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: IconButton(
                      ...
                      onPressed: (){
                        DeliveryAPi.searchValue = mycontroller[0].text;
                        setState(() {
                        deliveryValue.clear();
                        ...
                        DeliveryAPi.searchData().then((value) {
                              if(value.deliveryModaleValue!=null){
                                setState(() {
                                  deliveryValue = value.deliveryModaleValue!;
                                  deliveryValueFilter =deliveryValue;
                                });
                              }
                        });
            ...
            Expanded(
              child: ListView.builder(
                controller:scrollController,
                  itemCount: deliveryValueFilter.length,//dataSocialMedia.length,
                  itemBuilder: (context, i) { //i ==deliveryValueFilter.length-1
                    ...
                    return Card(
                        ...
                        child: InkWell(
                          onTap: () {
                         DeliveryDetailsAPi.docEntry = deliveryValueFilter[i].docEntry.toString();
                         Get.toNamed<dynamic>(FurneyRoutes.deliveyDetails);
                          },
                          child: Container(
                       ...
                       mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                         ...
                         //   color: Colors.greenAccent,
                            ...
                            child: Text('${deliveryValueFilter[i].DocNum}',
                          ...
                          //   color: Colors.blue,
                            ...
                            child: Text('${deliveryValueFilter[i].cardName}',
                            style: TextStyles.bodytextBlack1(context),),
                          )
                        ],
                      ),
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              // ),),
                                  Text('${deliveryValueFilter[i].DocDate}',style:TextStyles.bodytextBlack1(context),),
                              //   ],
                              // ),
                            ),
