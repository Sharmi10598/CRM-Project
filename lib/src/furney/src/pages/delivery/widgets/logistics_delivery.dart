...
class LogisticDelivery extends StatefulWidget {
  const LogisticDelivery({Key? key}) : super(key: key);

  @override
  LogisticDeliveryState createState() => LogisticDeliveryState();
}

class LogisticDeliveryState extends State<LogisticDelivery> {
  static AddressExtension? addressdata;
  @override
