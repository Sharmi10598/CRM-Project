                         ...
                         children: [
                            SizedBox(
                             ...
                             width: Screens.width(context)*0.57,
                                     child: Text('${customerDetailsValue!.bpaddress[i].addressName}',
                          ...
                          SizedBox(
                             ...
                             width: Screens.width(context)*0.3,
                                ...
                                style: TextStyles.boldPC1(context),),
                                 ...
                                 //     color: Colors.indigo,
                             width: Screens.width(context)*0.57,
                                     child: Text('${customerDetailsValue!.bpaddress[i].block}',
                                     style: TextStyles.headlineBlack1(context),
                                     ),
                                   ),
                                ],
                           ...
                           SizedBox(
                             ...
                             width: Screens.width(context)*0.3,
                                ...
                                //      color: Colors.indigo,
                             width: Screens.width(context)*0.57,
                                     child: Text('${customerDetailsValue!.bpaddress[i].street}',
                                     style: TextStyles.headlineBlack1(context),
                                     ),
                                   ),
                                ],
                             ...
                             width: Screens.width(context)*0.3,
                                ...
                                style: TextStyles.boldPC1(context),),
                                   ...
                                   SizedBox(
                                    //  color: Colors.indigo,
                             width: Screens.width(context)*0.57,
                                     child: Text('${customerDetailsValue!.bpaddress[i].city}',
                                     style: TextStyles.headlineBlack1(context),
                                     ),
                                   ),
                                ],
                             ...
                             width: Screens.width(context)*0.3,
                                ...
                                style:TextStyles.boldPC1(context),),
                                   ...
                                   SizedBox(
                                    //  color: Colors.indigo,
                             width: Screens.width(context)*0.57,
                                     child: Text('${customerDetailsValue!.bpaddress[i].state}',
                                     style: TextStyles.headlineBlack1(context),
                                     ),
                                   ),
                                ],
                             ...
                             width: Screens.width(context)*0.3,
                                ...
                                style:TextStyles.boldPC1(context),),
                                   ...
                                   SizedBox(
                                    //  color: Colors.indigo,
                             width: Screens.width(context)*0.57,
                                     child: Text('${customerDetailsValue!.bpaddress[i].country2}',
                                     style: TextStyles.headlineBlack1(context),
                                     ),
                                   ),
                                ],
