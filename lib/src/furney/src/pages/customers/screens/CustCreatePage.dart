...
class _CustomerCreatePageState extends State<CustomerCreatePage> {
  ...
  List<TextEditingController> mycontroller =  List.generate(25, (i) => TextEditingController());
...
errormsg = value.message!;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: 
      (groCustLoad == true && errormsg.isEmpty && groupcData.isEmpty )?
                            ...
                            child: DropdownButtonFormField<String>(
                                ...
                                onChanged: (String? value) {
                                  setState(() {
                                    ...
                                    if(seriesValue.toString().toLowerCase() == '218'){
                                    log('seriesValue $seriesValue');
                                      seriesValuebool = false;
                                    }else{
                                      seriesValuebool = true;
                                    }
                                    print("sleect code: "+seriesValue.toString());
                                  });
                                }),
                          ),
                                      ...
                                      Checkbox(
                                          ...
                                          onChanged: (val) {
                                            setState(() {
                                             ...
                                             if(samesAsBill == true){
                                              mycontroller[7].text = mycontroller[2].text;
                                              mycontroller[8].text = mycontroller[3].text;
                                              mycontroller[9].text = mycontroller[4].text;
                                              mycontroller[10].text = mycontroller[5].text;
                                              mycontroller[11].text = mycontroller[6].text;
                                             }else{
                ...
                tinFiles == null
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int i) {
                          if (tinFiles!.path.split('/').last.contains("png")) {
                            return Container(
           ...
           SizedBox(
                ...
                vatFiles == null
                    ...
                    ListView.builder(
                        ...
                        physics: BouncingScrollPhysics(),
                        itemBuilder: (BuildContext context, int i) {
                          if (vatFiles!.path.split('/').last.contains("png")) {
                            return Container(
                                child: Column(children: [
                              SizedBox(
                                height: 10,
               ...
               Container(
                            ...
                            child: DropdownButtonFormField<String>(
                                ...
                                onChanged: (String? value) {
                                  setState(() {
                                    teriteriValue = value!;
                                    print("teriteriValue: "+teriteriValue.toString());
                                  });
                                }),
                          ),
              SizedBox(height: Screens.heigth(context)*0.02,), 
               ...
               Container(
                            ...
                            child: DropdownButtonFormField<String>(
                                ...
                                onChanged: (String? value) {
                                  setState(() {
                                    paygrpValue = value!;
                                    print("paygrpValue: "+paygrpValue.toString());
                                  });
                                }),
                          ),
              //    Container(
              ...
              // ),
               SizedBox(height: Screens.heigth(context)*0.02,), 
                ...
                keyboardType: TextInputType.number,
                  ...
                  onEditingComplete: (){
mycontroller[17].text = TextStyles.splitValues(mycontroller[17].text);
                  },
                ...
                SizedBox(
                        ...
                        child: ElevatedButton(
                            onPressed:  loadingBtn == false? () {
                              if(tinFiles == null || vatFiles == null){
                                 setState((){
                                    fileValidation = true;
                                });
                              }else {
                              ...
                              if(formKey.currentState!.validate() & (tinFiles != null && vatFiles != null) ){
                                callPostApi();
                              }
                            }:null,
...
for (int i = 0; i < filedata.length; i++) {
  ...
  newCutomerModel.cardCode =mycontroller[0].text.isEmpty? null :mycontroller[0].text ;
  ...
  newCutomerModel.SalesPersonCode = mycontroller[15].text.isEmpty?null: int.parse(mycontroller[15].text);
  newCutomerModel.ContactPerson = mycontroller[16].text;
  newCutomerModel.CreditLimit = mycontroller[17].text.isEmpty?null: int.parse(mycontroller[17].text.replaceAll(",","").replaceAll(".",""));
  newCutomerModel.Notes = mycontroller[18].text;
  newCutomerModel.Series =seriesValue == null?null: int.parse(seriesValue!);
  newCutomerModel.Territory =teriteriValue == null?null: int.parse(teriteriValue!);
  newCutomerModel.PayTermsGrpCod =paygrpValue==null?null: int.parse(paygrpValue!);
  ...
  newCutomerModel.contEmp = [
    ContactEmployees(name:  mycontroller[16].text)
  ];
