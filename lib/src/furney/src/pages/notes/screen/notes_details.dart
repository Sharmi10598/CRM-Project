  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: 
        Padding(
          padding: EdgeInsets.symmetric(vertical: Screens.heigth(context)*0.02,horizontal: Screens.width(context)*0.02),
          child: Card(
            child: Container(padding:EdgeInsets.symmetric(vertical: Screens.heigth(context)*0.02,horizontal: Screens.width(context)*0.02),
