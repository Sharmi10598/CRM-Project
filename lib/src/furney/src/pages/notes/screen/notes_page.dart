                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            // }
                            return Card(
                              color: filterNotesData[i].IsSeen == '0'
                                  ? Colors.white
                                  : Colors.grey[200],
                              elevation: 8,
                              child: InkWell(
                                onTap: () {
                                  NotesDetailsState.heading =
                                      filterNotesData[i].MsgHeading;
                                  NotesDetailsState.description =
                                      filterNotesData[i].MsgDescription;
                                  Get.toNamed<dynamic>(
                                    FurneyRoutes.notesDetails,
                                  );
                                },
                                child: Container(
                                      ...
                                      SizedBox(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '${filterNotesData[i].CreatedDate}',
                                              style: TextStyles.bodytextBlack2(
                                                context,
                                              ),
                                            ),
                                            Text(
                                              '${filterNotesData[i].CreatedTime}',
                                              style: TextStyles.bodytextBlack2(
                                                context,
                                              ),
                                            ),
