                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          //   '${documentApprovalValue[index].Quantity}',
                             TextStyles.splitValues('${documentApprovalValue[index].quantity}'),
                            style: TextStyles.headlineBlack1(context),
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Text(
                            ...
                            TextStyles.splitValues('${documentApprovalValue[index].unitPrice}'),
                        ...
                        SizedBox(
                          ...
                          child: Text(
                           // '${documentApprovalValue[index].LineTotal}',
                            TextStyles.splitValues('${documentApprovalValue[index].lineTotal}'),
                            style: TextStyles.headlineBlack1(context),
                          ),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Text(
                            ...
                            TextStyles.splitValues('${documentApprovalValue[index].taxTotal}'),
                            style: TextStyles.headlineBlack1(context),
                          ),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Text(
                             ...
                             TextStyles.splitValues('${documentApprovalValue[index].total! * documentApprovalValue[index].quantity!}'),
                            style:TextStyles.headlineBlack1(context),
                          ),
                        ),
                      ],
