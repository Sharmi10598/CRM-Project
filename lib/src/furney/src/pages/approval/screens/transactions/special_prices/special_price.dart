...
class SpecialPrices extends StatefulWidget {
  const SpecialPrices({required this.title, Key? key}) : super(key: key);
  final String title;
  @override
  SpecialPricesState createState() => SpecialPricesState();
}

class SpecialPricesState extends State<SpecialPrices> {
