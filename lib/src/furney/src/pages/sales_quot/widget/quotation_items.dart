...
class SalesQuotItems extends StatefulWidget {
  const SalesQuotItems({required this.title, Key? key}) : super(key: key);
  final String title;
  @override
  SalesQuotItemsState createState() => SalesQuotItemsState();
}

class SalesQuotItemsState extends State<SalesQuotItems> {
  static int index = 0;
