...
class ApprovalsDetailsQuot extends StatefulWidget {
  const ApprovalsDetailsQuot({required this.title, Key? key}) : super(key: key);
  final String title;
  @override
  ApprovalsDetailsQuotState createState() => ApprovalsDetailsQuotState();
}

class ApprovalsDetailsQuotState extends State<ApprovalsDetailsQuot> {
