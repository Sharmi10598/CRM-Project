// ignore_for_file: require_trailing_commas, prefer_const_literals_to_create_immutables, prefer_const_constructors, empty_catches, prefer_single_quotes, unawaited_futures, unused_local_variable, omit_local_variable_types, avoid_void_async, prefer_if_elements_to_conditional_expressions, override_on_non_overriding_member, type_annotate_public_apis, always_declare_return_types, inference_failure_on_function_return_type
...
class EditORderDetailsState extends State<EditORderDetails> {
  ...
  void currentDate() {
    ...
    setState(() {
      ...
      print("date: ${HeaderEditOrderPageState.currentDateTime}");
    });
  }
            ...
            body: Padding(
              ...
              child: TabBarView(
                  ...
                  children: [
                    ...
                    isloading == true
                        ? lodingWid()
                        : const HeaderEditOrderPage(),
                    isloading == true
                        ? lodingWid()
                        : const ContentOrderEdit(),
                    isloading == true ? lodingWid() :
                  LogisticEditORder(docEntry: widget.DocEntry,
