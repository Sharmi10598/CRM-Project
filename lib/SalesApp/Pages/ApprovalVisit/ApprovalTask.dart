...
class _ApprovalTaskState extends State<ApprovalTask> {
                                  ...
                                  child: DropdownButtonFormField<String>(
                                      ...
                                      onChanged: (String? value) {
                                        setState(() {
                                          ...
                                          apiError2 = '';
                                          codeValue = value!;
                                          callGetActivities(codeValue.toString());
                                          print(
                                                            ...
                                                            showDialog<void>(
                                                                ...
                                                                builder: (_) {
                                                                  return MyApprovalDialog(
                                                                    clgcode: activitiesData[index].ClgCode,
                                                                    activiti: activitiesData[index],
                                                                    );
                                                                }).then((value) {
                                                                   loadinapi2 = false;
                                                                   apiError2 = '';
 ...
 Future<void> approveAll() async{
    ...
    for(int i=0; i<activitiesData.length; i++ ){
        ApproveVisitModel aprv = new ApproveVisitModel(clgCode: activitiesData[i].ClgCode!, status: 'A');
  ...
  Future<void> rejectAll()async{
    ...
    int success = 0;
     ...
     RejectVisitModel aprv = new RejectVisitModel(
      clgCode:activitiesData[i].ClgCode!, status: 'R', remarks: rejectAllCl.text);
                ...
                Column(
                  ...
                  children: [
                    ...
                    style: theme.textTheme.bodyMedium?.copyWith(
                     ...
                     Container(child: Text('${activitiesData[ind].CardCode}')),
                  ],
                )),
                 SizedBox(
                       width: Screens.width(context)*0.35,
                ...
                Column(
                  ...
                  children: [
                    ...
                    style: theme.textTheme.bodyMedium?.copyWith(
                     ...
                     Container(child: Text(config.alignDate('${activitiesData[ind].U_PlanDate}'))),
                  ],
                )),
              ],
            ),
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Container(
                      child: Text('Time',style: theme.textTheme.bodyMedium?.copyWith(
                      color: Colors.black
                    ),)),
                     Container(
                      child: Text('${activitiesData[ind].U_PlanTime}')),
                  ],
                )),
              ],
            ),
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Container(
                      child: Text('Purpose',style: theme.textTheme.bodyMedium?.copyWith(
                      color: Colors.black
                    ),)),
                     Container(
                ...
                Column(
                  ...
                  children: [
                    Container(
                      child: Text('SlpName',style: theme.textTheme.bodyMedium?.copyWith(
                      color: Colors.black
                    ),)),
                     Container(
