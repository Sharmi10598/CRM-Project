// ignore_for_file: unnecessary_lambdas, prefer_const_constructors, prefer_const_literals_to_create_immutables, unnecessary_new, prefer_final_locals, omit_local_variable_types, prefer_single_quotes, prefer_if_elements_to_conditional_expressions
...
class RejectDialog extends StatefulWidget {
   RejectDialog({required this.clgcode, required this.activiti, Key? key}) : super(key: key);
   int? clgcode;
...
class MyDialogState extends State<RejectDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      actions:
      isLoading == true && message.isEmpty?
     <Widget>[ SizedBox()]
      :
       <Widget>[
        TextButton(
...
Future<void> callRejectApi() async{
  ...
  RejectVisitModel aprv = new RejectVisitModel(clgCode: widget.clgcode!,
   status: 'R', remarks: mycontroller[0].text,);
