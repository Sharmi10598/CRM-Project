...
class GetVisitListAPi {
  static Future<VistListModel> getGlobalData(String date) async {
    try {
      ...
      log("VisitList Res: " + json.decode(response.body).toString());
